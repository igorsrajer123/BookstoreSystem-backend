...
--user password: 1234
INSERT INTO user_entity(email, password, first_name, last_name, type, activated, enabled, first_login, phone_number, date_of_birth, address, city, profile_image_name) VALUES ('sysadmin@gmail.com', '$2a$10$Ng8dAJzSDmWjbsuQmKb7WeOl27Kc5DlySVmClnvfqaD7VAZqFW7v6', 'Marko', 'Markovic', 'ROLE_SYSTEM_ADMIN', true, true, true, '+3816656213', '09/26/1994', 'Frankopanova 9', 'Novi Sad', 'sysAdmin.jpg');
--user password: 12345
...
--books
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (1, '115521', 'Game of Thrones', 1555, 'descrption1234', '2020-05-01', 'BOOK', 1, 400, 'SERBIAN', 'gameOfThrones.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (2, '5551231', 'Lord of the Rings: Two Towers', 1500, 'description2222', '2020-05-01', 'BOOK', 2, 420, 'SERBIAN', 'twoTowers.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (3, '332515', 'Lord of the Rings: Fellowship of the Ring', 1200, 'descrption3333', '2020-05-01', 'BOOK', 2, 510, 'SERBIAN', 'fellowshipOfTheRing.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (4, '6532', 'Lord of the Rings: Return of the King', 1200, 'descrption4444', '2020-05-01', 'BOOK', 2, 390, 'SERBIAN', 'returnOfTheKing.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (5, '54536', 'Harry Potter and the Philosophers Stone', 1500, 'descrption555', '2020-05-01', 'BOOK', 3, 290, 'SERBIAN', 'harryPotter1.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (6, '785657', 'Harry Potter and the Half Blood Prince', 1700, 'descrption6666', '2020-05-01', 'BOOK', 3, 320, 'SERBIAN', 'harryPotter6.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (7, '421564', 'Harry Potter and the Chamber of Secrets', 1300, 'descrption777', '2020-05-01', 'BOOK', 3, 210, 'SERBIAN', 'harryPotter2.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (8, '987077', 'Harry Potter and the Prisoner of Azkaban', 1400, 'descrption8888', '2020-05-01', 'BOOK', 3, 110, 'SERBIAN', 'harryPotter3.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (9, '654787', 'Harry Potter and the Goblet of Fire', 1500, 'descrption9999', '2020-05-01', 'BOOK', 3, 400, 'SERBIAN', 'harryPotter4.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (10, '3255661', 'Harry Potter and the Order of Phoenix', 2100, 'descrption101010', '2020-05-01', 'BOOK', 3, 280, 'SERBIAN', 'harryPotter5.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (11, '3166643', 'Harry Potter and the Deathly Hallows', 1750, 'descrption11111', '2020-05-01', 'BOOK', 3, 350, 'SERBIAN', 'harryPotter7.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (12, '5544511', 'The Fall of Gondolin', 1100, 'descrption54321', '2020-05-01', 'BOOK', 1, 250, 'SERBIAN', 'fallOfGondolin.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (13, '3213415', 'The Silmarillion', 1300, 'descrption5551', '2020-05-01', 'BOOK', 1, 232, 'SERBIAN', 'silmarillion.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (14, '6546478', 'The Hobbit', 1000, 'descrption5551', '2020-05-01', 'BOOK', 1, 400, 'SERBIAN', 'hobbit.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (15, '4234326', 'A Clash of Kings', 1300, 'descrption5551', '2020-05-01', 'BOOK', 2, 270, 'SERBIAN', 'clashOfKings.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (16, '4277656', 'A Storm of Swords', 2500, 'descrption5551', '2020-05-01', 'BOOK', 2, 300, 'SERBIAN', 'stormOfSwords.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (17, '8786667', 'A Feast for Crows', 2100, 'descrption5551', '2020-05-01', 'BOOK', 2, 190, 'SERBIAN', 'feastForCrows.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (18, '7868455', 'A Dance with Dragons', 2700, 'descrption5551', '2020-05-01', 'BOOK', 2, 360, 'SERBIAN', 'danceWithDragons.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (19, '54353767', 'The Winds of Winter', 2700, 'descrption5551', '2020-05-01', 'BOOK', 2, 240, 'SERBIAN', 'windsOfWinter.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (20, '34363646', 'Fire & Blood', 2999, 'descrption5551', '2020-05-01', 'BOOK', 2, 400, 'SERBIAN', 'fireAndBlood.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (21, '125512', 'The Adventures of Tom Sawyer', 900, 'descrption5551', '2020-05-01', 'BOOK', 4, 260, 'SERBIAN', 'tomSawyer.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (22, '321556', 'Adventures of Huckleberry Finn', 900, 'descrption5551', '2020-05-01', 'BOOK', 4, 300, 'SERBIAN', 'huckleberryFinn.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (23, '7657657', 'Animal Farm', 700, 'descrption5551', '2020-05-01', 'BOOK', 5, 400, 'SERBIAN', 'animalFarm.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (24, '65758354', '1984', 800, 'descrption5551', '2020-05-01', 'BOOK', 5, 320, 'SERBIAN', '1984.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (25, '54353467', 'It', 2700, 'descrption5551', '2020-05-01', 'BOOK', 10, 400, 'SERBIAN', 'it.png');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (26, '5435', 'Misery', 900, 'descrptio49219', '2020-05-01', 'BOOK', 10, 390, 'SERBIAN', 'misery.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (27, '4324', 'The Shining', 1100, 'descrption32135', '2020-05-01', 'BOOK', 10, 200, 'SERBIAN', 'shining.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (28, '6642', 'Carrie', 1000, 'descrption553251', '2020-05-01', 'BOOK', 10, 100, 'SERBIAN', 'carrie.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (29, '22131', 'Pet Sematary', 1500, 'descrption51123', '2020-05-01', 'BOOK', 10, 90, 'SERBIAN', 'petSematary.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (30, '21556', 'Murder on the Orient Express', 2100, 'descrption66545', '2020-05-01', 'BOOK', 11, 510, 'SERBIAN', 'orientExpress.png');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (31, '222135', 'Three Act Tragedy', 1000, 'descrption51111', '2020-05-01', 'BOOK', 11, 330, 'SERBIAN', 'threeActTragedy.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (32, '66546', 'Sleeping Murder', 1000, 'descrption99921', '2020-05-01', 'BOOK', 11, 310, 'SERBIAN', 'sleepingMurder.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (33, '43242', 'Passenger to Frankfurt', 900, 'descrption675756', '2020-05-01', 'BOOK', 11, 150, 'SERBIAN', 'passengerToFrankfurt.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (38, '7652234', 'The Old Man and the Sea', 600, 'descrption696969', '2020-05-01', 'BOOK', 14, 170, 'SERBIAN', 'oldManAndTheSea.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (39, '32166', 'The Garden of Eden', 760, 'descrption666', '2020-05-01', 'BOOK', 14, 215, 'SERBIAN', 'gardenOfEden.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (40, '331663', 'A Farewell to Arms', 900, 'descrptio6643', '2020-05-01', 'BOOK', 14, 175, 'SERBIAN', 'farewellToArms.jpg');
INSERT INTO book(id, code, name, price, description, published, type, publisher_id, number_of_pages, language, cover_image) VALUES (41, '3332156', 'For Whom the Bell Tolls', 1000, 'descrption321312', '2020-05-01', 'BOOK', 14, 120, 'SERBIAN', 'forWhomTheBellTolls.jpg');
